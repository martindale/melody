...
var Peer = melody.define('Peer', {
  attributes: {
    _key: { type: melody.mongoose.SchemaTypes.ObjectId , ref: 'Key' }
  }
});

var Identity = melody.define('Identity', {
  attributes: {
    username: { type: String , slug: true },
    keys: [ { type: melody.mongoose.SchemaTypes.ObjectId , ref: 'Key' } ]
  }
});
